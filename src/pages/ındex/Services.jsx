    ...
    <div className='my-10 flex flex-col justify-center items-center bg-gray-100 p-10'>
        ...
        <div className='grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 p-5 gap-10'>
            ...
            <div className='flex flex-col justify-center items-center h-96 gap-4 p-4 hover:scale-110 transition-all'>
                <div className='flex justify-center items-center shadow text-center h-4/5 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-3'>
            ...
            {/* card 2 */}
            <div className='flex flex-col justify-center items-center h-96 gap-4 p-4 hover:scale-110 transition-all'>
                <div className='flex justify-center items-center shadow text-center h-4/5 bg-gradient-to-r from-pink-500 to-fuchsia-500 text-white px-3'>
             ...
             {/* card 3 */}
             <div className='flex flex-col justify-center items-center h-96 gap-4 p-4 hover:scale-110 transition-all'>
                <div className='flex justify-center items-center shadow text-center h-4/5 bg-gradient-to-r from-orange-500 to-amber-500 text-white px-3'>
             ...
             {/* card 4 */}
             <div className='flex flex-col justify-center items-center h-96 gap-4 p-4 hover:scale-110 transition-all'>
                <div className='flex justify-center items-center shadow text-center h-4/5 bg-gradient-to-r from-red-500 to-rose-500 text-white px-3'>
                    <p>Tüm Soruların Videolu Çözümleri</p>
                </div>

                <div className='border rounded shadow bg-white py-2 px-4 w-full text-center'>
                    <p className='text-red-500 font-semibold'>Çözüm Videolarını İncele</p>
                </div>
            </div>

            {/* card 5 */}
            <div className='flex flex-col justify-center items-center h-96 gap-4 p-4 hover:scale-110 transition-all'>
                <div className='flex justify-center items-center text-center shadow h-4/5 bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3'>
